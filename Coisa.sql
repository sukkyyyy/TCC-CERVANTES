...
-- 2. Tabela de Famílias Olfativas
CREATE TABLE familias_olfativas (
    id INT AUTO_INCREMENT PRIMARY KEY,
    nome VARCHAR(100) NOT NULL UNIQUE
);

-- 3. Tabela Principal de Perfumes
...
-- 4. Tabela de Notas Olfativas (Para perfumes que possuem a pirâmide detalhada)
...
-- Inserindo as Famílias Olfativas únicas
...
-- Inserindo os Perfumes e guardando os IDs gerados para as notas
-- Nota: O preço é inserido com ponto decimal (padrão SQL)
...
-- 11. BLEU INFINI (Sem pirâmide detalhada de notas)
INSERT INTO perfumes (nome, preco, familia_id, essencia_principal, descricao) 
...
-- 12. CITRUS FRAIS
INSERT INTO perfumes (nome, preco, familia_id, essencia_principal, descricao) 
VALUES ('CITRUS FRAIS', 159.90, (SELECT id FROM familias_olfativas WHERE nome='Cítrico Fresco'), 'Laranja Siciliana • Limão • Musk', 'Leve, vibrantee perfeito para dias quentes.');
